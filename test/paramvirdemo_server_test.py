...
class paramvirdemoTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('paramvirdemo'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = paramvirdemo(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_paramvirdemo_" + str(suffix)
